...
const StockistRetailHistory = () => {
  ...
  const getSponserData = async () => {
    try {
      ...
      const response = await axiosInstance.post(
        apiRoutes.getStockistRetailHistory,
        {
  ...
  return (
    <View style={styles.screen}>
      {visible && <Loader />}
      <Text style={styles.headerText}>Stockist Retail History</Text>
...
export default React.memo(StockistRetailHistory);
